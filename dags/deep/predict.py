...
from deep.unet import UNet
from deep.utils.data_vis import plot_img_and_mask
from deep.utils.dataset import BasicDataset
...
def run_script(model, input_path, output_path):
    path_dir = input_path
    ...
    folder_name = output_path + "/segmentation"
